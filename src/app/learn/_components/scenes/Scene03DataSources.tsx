      ...
      <div style={{ width: "100%", maxWidth: 920 }}>
        ...
        <motion.h2
          ...
          style={{
            ...
            fontWeight: 900, fontSize: "clamp(1.7rem, 3.5vw, 2.6rem)",
        ...
        {/* ── Main layout: Sources | Connector | CDP ── */}
        <div style={{
          display: "grid",
            ...
            {SOURCES.map((src, i) => (
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontSize: 14, fontWeight: 700, color: COLORS.fg, marginBottom: 3 }}>
                    {src.label}
                  </div>
                  <div style={{
                    fontFamily: "var(--font-jetbrains-mono), monospace",
          ...
          >
            ...
            <div style={{
              fontFamily: "var(--font-jetbrains-mono), monospace",
              fontSize: 11, opacity: 0.75, letterSpacing: "0.1em",
          ...
          {SOURCES.map((src) => (
            <span
              ...
              style={{
                ...
                fontSize: 12, color: COLORS.fgSecondary, fontWeight: 500,
              }}
            >
              <span style={{
