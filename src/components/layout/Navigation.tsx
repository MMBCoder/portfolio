...
// #0066CC on white = 5.57:1 contrast (WCAG AA ✓). Hover = 10% darker.
const CTA_BG = "#0066CC";
const CTA_HOVER = "#005CB8";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Right: trust badges + CTA + hamburger */}
        <div style={{ marginLeft: "auto", display: "flex", alignItems: "center" }}>

          {/* Social trust badges — desktop only, 12px gap to CTA */}
          <div className="hidden md:flex" style={{ alignItems: "center", gap: "2px" }}>
            ...
            {/* Divider — 12px right margin to CTA */}
            <div style={{ width: "1px", height: "18px", background: "rgba(255,255,255,0.15)", margin: "0 12px 0 5px" }} />
          </div>
          ...
          <button
            ...
            style={{ color: "#FFFFFF", background: "none", border: "none", cursor: "pointer", padding: "4px", marginLeft: "8px" }}
